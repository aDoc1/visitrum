...
{
    /// <summary>
    /// This is a game component that implements the pause menu.
    /// </summary>
    public class PauseScene : GameScene
    {
        ...
        public PauseScene(Game game, SpriteFont smallFont, SpriteFont largeFont,
            ...
            : base(game)
        {
            ...
            // Create the Menu
            string[] items = { "Resume","High Scores", "Help", "Main Menu" };
            pauseMenu = new TextMenuComponent(game, smallFont, largeFont);
            pauseMenu.SetMenuItems(items);
        ...
        {
            get { return pauseMenu.SelectedIndex; }
        }
