...
namespace Visitrum
{
    ...
    /// </summary>
    public class HardActionScene : GameScene
    {
        // Basics
        ...
        public HardActionScene(Game game, Texture2D theTexture,
            ...
            : base(game)
        {
            ...
            //meteors = new MeteorManager(Game, ref actionTexture);
...
#if XBOX360
            player1 = new Player(Game, ref actionTexture, PlayerIndex.One, new Rectangle(5, 10, 230, 26), 1);
#endif
            ...
            gameTextAry[2] = "Level 10. Are you ready for some color mixing?  Orange, Purple, Cyan, Yellow-Green, and Brown are added.  15 blocks are needed to get to the next level. Slight change of speed.";
            gameTextAry[3] = "Level 15. It's looking a little shady in here.  Dark-Blue, Grey, Dark-Red, Light-Green, and Pink are added.  20 Blocks gets you to the next level. Getting kind of fast.";
            gameTextAry[4] = "Level 20. Is it getting faster in here?  Can you keep up?";
            gameTextAry[5] = "Level 25. More speed Captain!";
            gameTextAry[6] = "Level 30. Speed has doubled!";
